...
<!-- Content vetted 1/21/2026 mjc-->

<!--
As part of the automated pre-deployment steps for this lab environment, a storage account named **sa@lab.LabInstance.Id** was provisioned. This Azure Data Lake Storage Gen2 (ADLS Gen2) storage account provides scalable, secure, and cost-effective storage for big data analytics workloads. -->

In this task, you'll add a role assignment to the storage account. You'll then verify that the containers named **litwaredata**, **data** and **products** exist.
