...
1. Place your mouse cursor over the green circle that appears on the right side of the **RealtimeDataToKQLDatabase** node on the canvas.

    ![ttor3bfy.jpg](../../media/ttor3bfy.jpg)

1. Hold your left mouse button down and drag the cursor to the red circle that appears on the left side of the **Eventhouse@lab.LabInstance.Id** node. This creates a connection between the nodes. Your canvas should resemble the screenshot below.

    ![uzxro3dn.jpg](../../media/uzxro3dn.jpg)
