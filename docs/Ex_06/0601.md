---
title: '1. Start the thermostat & occupancy simulator'
layout: default
nav_order: 1
parent: 'Exercise 06: Explore real-time intelligence in Fabric'
---

## Task 01: Start the thermostat & occupancy simulator
...
1. Verify that streaming has started. 
    ...
    {: .warning }
    > Do not close the PowerShell window until you complete Exercise 6.
    >
