...
1. On the **Choose data** page, in the **Catalog name** field, select **dbkwks@lab.LabInstance.Id**.
    ...
    >
    > If the issue occurs, close the dialog and then restart Task 3.

1. Select **schema@lab.LabInstance.Id_processeddata**. Clear the checkboxes for all other schemas.

    ![7dhgqce8.jpg](../../media/7dhgqce8.jpg)

1. Select **Automatically sync future catalog changes for the selected schema** and then select **Next**.
...
1. On the **Explorer** pane, select **Refresh**.
